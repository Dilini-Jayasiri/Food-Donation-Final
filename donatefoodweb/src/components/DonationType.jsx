  ...
  return (
   ...
   <Row className='donationType'>    
     ...
     <Col xs={12} className='md-5 my-3'>
      ...
      <Col xs={12} className='md-5 mt-4 mb-2'>
           <center>     
        ...
        <Col xs={12} className='md-5 mt-4 mb-2'>
           <center>     
            <NavLink style={navLinkStyles} to="/reservedDonationNew">
              <GradientButton style={{ backgroundImage: `linear-gradient(to right, #1abc9c 50%, #16a085 100%)`, }} >Common Donation</GradientButton>
            </NavLink>            
           </center>
        </Col>
        <Col xs={12} className='md-5 my-3'>
           <center>
              <label>(YOU CAN RESERVED A DATE  AND  MAKE  YOUR  DONATION WITHOUT SELECTING ORGANIZATION)</label>
           </center>
        </Col>
     </Row>
     <Footer/>
