        ...
        <div className="container my-5 py-5">
            <div className="row">
                <div className="col-12">
                    ...
                    <h1 className='display-6 text-center mb-4'>For Additional Meal</h1>
                    <hr className='w-25 mx-auto'/>
                </div>
            ...
            <div className='row mt-5'>
                <div className="col-md-4">
                <div class="card p-3">
                <img src={require('../assets/cupcake.jpg')} class="card-img-top" alt="breakfast" height={'300px'}/>
                     <div class="card-body text-center">
                        {/* <i className='fa fa-cogs fa-4x mb-4 text-primary'></i> */}
                        <h5 class="card-title mb-3 fs-4 fw-bold">Desserts</h5>
                ...
                <div className="col-md-4">
                <div class="card p-3">
                  <img src={require('../assets/pizza.jpg')} class="card-img-top" alt="lunch" height={'300px'}/>
                     <div class="card-body text-center">
                        {/* <i className='fa fa-cogs fa-4x mb-4 text-primary'></i> */}
                        <h5 class="card-title mb-3 fs-4 fw-bold">Short eats</h5>
                        <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                     </div>
                </div>
                </div>
                <div className="col-md-4">
                <div class="card p-3">
                  <img src={require('../assets/fruits.jpg')} class="card-img-top" alt="dinner"  height={'300px'}/>
                     <div class="card-body text-center">
                        {/* <i className='fa fa-cogs fa-4x mb-4 text-primary'></i> */}
                        <h5 class="card-title mb-3 fs-4 fw-bold">Fruits</h5>
                        <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                     </div>
                </div>
